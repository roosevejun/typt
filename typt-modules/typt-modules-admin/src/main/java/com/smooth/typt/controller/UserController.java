package com.smooth.typt.controller;
...
import com.smooth.typt.common.dto.AjaxResult;
import com.smooth.typt.common.entity.PageModel;
import com.smooth.typt.common.util.ExcelUtils;
import com.smooth.typt.common.util.Md5Util;
...
import com.smooth.typt.org.service.ResourceService;
import com.smooth.typt.org.service.RoleService;
import com.smooth.typt.org.service.UserService;
import com.smooth.typt.util.Constants;
import com.smooth.typt.util.WebHelper;
...
public class UserController {
    ...
    public String exportOrder(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (userList != null && userList.size() > 0) {
            for (User user : userList) {
                ...
                String createDate = "";
                String roleName = "";
                if (StringUtils.isNotBlank(user.getDeleteFlag().toString()) && user.getDeleteFlag().equals(User.DELETE_FLAG_DELETED)) {
                    statusName = "删除";
                }
    ...
    public AjaxResult ajaxUpdRoleDeleteFlag(HttpServletRequest request) {
        ...
        try {
            ...
            roleService.updateDeleteFlag(ids, Integer.valueOf(deleteFlag));
    ...
    public AjaxResult ajaxUpdMenuDeleteFlag(HttpServletRequest request) {
        ...
        try {
            String[] ids = request.getParameterValues("ids");
            String deleteFlag = request.getParameter("deleteFlag");
            resourceService.updateDeleteFlag(ids, Integer.valueOf(deleteFlag));
