package com.smooth.typt.common.entity;
 ...
 */
@MappedSuperclass
public class BaseEntity extends UUIDSequenceIdEntity implements Serializable{
	...
	@Column(name = "delete_flag",precision = 1 , columnDefinition = "int default 0", nullable = false)
    ...
    public void prePersist() {
		...
		if(StringUtils.isBlank(this.getDeleteFlag().toString())){
